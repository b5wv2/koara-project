export const generateReportHtml = (data, lang, base64Logo) => {
  const isAr = lang === 'ar';
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="grid">
          ...
          <div class="card"><div class="card-label">${t.walletTopups}</div><div class="card-value">${financialSummary.walletTopups}</div></div>
          <div class="card"><div class="card-label">${t.walletDeposited}</div><div class="card-value" dir="ltr" style="text-align: ${isAr ? 'right' : 'left'}">${formatCurrency(financialSummary.walletDeposited)}</div></div>
        </div>
        <div class="grid" style="margin-top:15px;">
          <div class="card"><div class="card-label">${t.grossSales}</div><div class="card-value" dir="ltr" style="text-align: ${isAr ? 'right' : 'left'}">${formatCurrency(financialSummary.grossSales)}</div></div>
          <div class="card"><div class="card-label">${t.refundedAmount}</div><div class="card-value" dir="ltr" style="text-align: ${isAr ? 'right' : 'left'}">${formatCurrency(financialSummary.refundedAmount)}</div></div>
          <div class="card"><div class="card-label">${t.netSales}</div><div class="card-value" dir="ltr" style="text-align: ${isAr ? 'right' : 'left'}">${formatCurrency(financialSummary.netSales)}</div></div>
          <div class="card"><div class="card-label">${t.avgOrderVal}</div><div class="card-value" dir="ltr" style="text-align: ${isAr ? 'right' : 'left'}">${formatCurrency(financialSummary.avgOrderVal)}</div></div>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="grid">
          <div class="card"><div class="card-label">${t.totalOrders}</div><div class="card-value">${o.totalOrders}</div></div>
          <div class="card"><div class="card-label">${t.pendingOrders}</div><div class="card-value">${o.pendingOrders}</div></div>
          <div class="card"><div class="card-label">${t.processingOrders}</div><div class="card-value">${o.processingOrders}</div></div>
        </div>
        <div class="grid" style="margin-top:15px;">
          <div class="card"><div class="card-label">${t.completedOrders}</div><div class="card-value">${o.completedOrders}</div></div>
          <div class="card"><div class="card-label">${t.rejectedOrders}</div><div class="card-value">${o.rejectedOrders}</div></div>
          <div class="card"><div class="card-label">${t.refundedOrders}</div><div class="card-value">${o.refundedOrders}</div></div>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="grid">
          <div class="card"><div class="card-label">${t.bestProduct}</div><div class="card-value" dir="auto">${statistics.bestProduct || 'N/A'}</div></div>
          <div class="card"><div class="card-label">${t.firstOrderDate}</div><div class="card-value" dir="auto">${formatDate(statistics.firstOrderDate)}</div></div>
          <div class="card"><div class="card-label">${t.latestOrderDate}</div><div class="card-value" dir="auto">${formatDate(statistics.latestOrderDate)}</div></div>
          <div class="card"><div class="card-label">${t.avgOrdersDay}</div><div class="card-value" dir="auto">${statistics.avgOrdersDay}</div></div>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <table>
          ...
          <tbody>
            ${productsSummary.map(p => `<tr><td dir="auto">${p.product_name || 'Unknown Product'}</td><td>${p.quantity_sold}</td><td dir="ltr" style="text-align: ${isAr ? 'right' : 'left'}">${formatCurrency(p.revenue)}</td></tr>`).join('')}
          </tbody>
        </table>
