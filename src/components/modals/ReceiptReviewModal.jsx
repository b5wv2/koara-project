      ...
      {selectedReceipt && (
        <div className="space-y-5 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <DashButton
              onClick={() => onProcessOrder(selectedReceipt.id, 'rejected', selectedReceipt.order_type === 'topup')}
              className="dash-btn dash-btn-danger flex-1 justify-center py-2.5 rounded-xl"
            >
              Reject Order
            </DashButton>
            <DashButton
              onClick={() => onProcessOrder(selectedReceipt.id, 'approved', selectedReceipt.order_type === 'topup')}
